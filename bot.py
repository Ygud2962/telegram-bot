...
SCHEDULE_STRUCTURED = {
    ...
    '10': {
        'Понедельник': [
            ...
            (5, 'Матем(проф)/Математика', 'Анисковец Н.В./Гуд Ю.П.'),
            (6, 'Биология(проф)/Английский язык(проф)', 'Даниленко А.А./Нечаева Е.Я.'),
        ],
        'Вторник': [
            (1, 'Черчение', 'Михасёв В.А.'),
            (2, 'Англ яз(проф)/Английский язык', 'Нечаева Е.Я./Тихоненко О.А.'),
            (3, 'Физика', 'Стишенок Н.И.'),
            (4, 'Химия(проф)/Химия(база)', 'Канунова В.Г./Корольчук О.Г.'),
            (5, 'Матем(проф)/Математика', 'Анисковец Н.В./Гуд Ю.П.'),
            (6, 'Физическая культура', 'Вергейчик В.Л./Смольский С.М.'),
            (7, 'Матем(проф)/Химия(проф)', 'Анисковец Н.В./Канунова В.Г.'),
        ],
        'Среда': [
            ...
            (6, 'Матем(проф)/Химия(проф)', 'Анисковец Н.В./Канунова В.Г.'),
        ],
        'Четверг': [
            (1, 'История', 'Королёва Ж.В.'),
            (2, 'Физика', 'Стишенок Н.И.'),
            (3, 'Матем(проф)/Математика', 'Анисковец Н.В./Гуд Ю.П.'),
