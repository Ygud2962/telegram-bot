...
SCHEDULE_STRUCTURED = {
    '5а': {
        ...
        'Вторник': [
            ...
            (4,'Физическая культура и здоровье','Вергейчик В.Л.'),
    ...
    '5б': {
        ...
        'Среда': [
            (1,'Математика','Назаренко Т.К.'),
            (2,'Физическая культура и здоровье','Вергейчик В.Л.'),
    ...
    '5в': {
        ...
        'Вторник': [
            (1,'Физическая культура и здоровье','Явош С.В.'),
    ...
    '6а': {
        ...
        'Пятница': [
            ...
            (4,'Физическая культура и здоровье','Явош С.В.'),
            (5,'Математика','Прихач Е.В.'),
    ...
    '6в': {
        ...
        'Четверг': [
            ...
            (5,'Физическая культура и здоровье','Смольский С.М.'),
            (6,'Белорусский язык','Грицкевич Л.В.'),
        ],
        'Пятница': [
            (1,'Физическая культура и здоровье','Смольский С.М.'),
    ...
    '7а': {
        ...
        'Среда': [
            ...
            (2,'Физика','Бенько О.Н.'),
            (3,'Физическая культура и здоровье','Смольский С.М.'),
    ...
    '7б': {
        ...
        'Среда': [
            ...
            (5,'Физическая культура и здоровье','Вергейчик В.Л.'),
            (6,'Трудовое обучение','Мележ А.Г./Михасёв В.А.'),
        ],
        'Четверг': [
    ...
    '7в': {
        ...
        'Вторник': [
            ...
            (6,'Физическая культура и здоровье','Смольский С.М.'),
        ],
        'Среда': [
            (1,'Физика','Зубок С.Н.'),
    ...
    '8а': {
        ...
        'Вторник': [
            ...
            (2,'Физическая культура и здоровье','Явош С.В.'),
    ...
    '8б': {
        ...
        'Среда': [
            (1,'Физическая культура и здоровье','Вергейчик В.Л.'),
            (2,'Математика','Анисковец Н.В.'),
    ...
    '9а': {
        ...
        'Вторник': [
            (1,'Физика','Зубок С.Н.'),
            (2,'Математика','Анисковец Н.В.'),
            (3,'История','Королева Ж.В.'),
            (4,'Белорусская литература','Лукьяненко Л.И.'),
        ...
        'Среда': [
            ...
            (3,'Химия','Канунова В.Г.'),
            (4,'Математика','Анисковец Н.В.'),
            (5,'Белорусская литература','Лукьяненко Л.И.'),
            (6,'География','Юнах Т.В.'),
            (7,'Английский язык','Нечаева Е.Я.'),
        ],
        'Четверг': [
    ...
    '10а': {
        ...
        'Вторник': [
            ...
            (2,'Физическая культура и здоровье','Смольский С.М.'),
            (3,'Химия','Корольчук О.Г.'),
            (4,'Биология','Канунова В.Г.'),
            (5,'История','Сивый А.В.'),
        ...
        'Среда': [
            (1,'Русский язык','Пинчук А.В.'),
            (2,'Допризывная/медицинская подготовка','Даниленко А.А./Смольский С.М.'),
            (3,'Белорусская литература','Анисенко С.В.'),
            (4,'Физическая культура и здоровье','Смольский С.М./Вергейчик В.Л.'),
            (5,'Математика (проф)/Математика (база)','Коротчикова Л.В./Назаренко Т.К.'),
    ...
    '10б': {
        ...
        'Вторник': [
            ...
            (4,'Английский язык (проф)/Химия (проф)','Приходько И.Н./Корольчук О.Г.'),
            (5,'Физическая культура и здоровье','Смольский С.М.'),
        ...
        'Среда': [
            ...
            (5,'Английский язык (база)/История (проф)','Тихоненко О.А./Королёва Ж.В.'),
            (6,'Русский язык','Леонова Д.А.'),
            (7,'Биология (проф)/Химия (база)','Даниленко А.А./Корольчук О.Г.'),
        ],
        'Четверг': [
            (1,'География','Юнах Т.В.'),
            (2,'Белорусский язык','Лебедевская М.П.'),
    ...
    '11': {
        ...
        'Вторник': [
            ...
            (2,'История','Королёва Ж.В.'),
            (3,'Физическая культура и здоровье','Вергейчик В.Л./Явош С.В.'),
            (4,'Английский язык (база)/Русский язык (проф)','Хорошко Т.А./Пинчук А.В.'),
            (5,'Английский язык (проф)/Русский язык (база)','Тихоненко О.А./Пинчук А.В.'),
            (6,'Русский язык (проф)/Химия (проф)','Пинчук А.В./Корольчук О.Г.'),
        ],
        'Среда': [
            (1,'Информатика','Гуд Ю.П./Прихач Е.П.'),
            (2,'География','Юнах Т.В.'),
            (3,'Математика','Коротчикова Л.В.'),
            (4,'Биология (база)/Химия (проф)','Даниленко А.А./Корольчук О.Г.'),
            (5,'Белорусский язык','Лукьяненко Л.И.'),
            (6,'Допризывная/медицинская подготовка','Даниленко А.А./Явош С.В.'),
        ],
        'Четверг': [
            (1,'Математика','Коротчикова Л.В.'),
