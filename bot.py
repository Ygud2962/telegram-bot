...
SCHEDULE_STRUCTURED = {
    '5а': {
        ...
        'Пятница': [
            ...
            (6, 'Физическая культура и здоровье', 'Вергейчик В.Л.'),
        ],
    },
    '5б': {
        'Понедельник': [
    ...
    '5в': {
        'Понедельник': [
            ...
            (3, 'История', 'Сивый А.В.'),
            (4, 'Английский язык', 'Ковальчук К.Р./Тихоненко О.А.'),
            (5, 'Физическая культура и здоровье', 'Явош С.В.'),
        ...
        'Пятница': [
            (1, 'ОБЖ', 'Юнах Т.В.'),
            (2, 'Математика', 'Прихач Е.В.'),
            (3, 'Физическая культура и здоровье', 'Явош С.В.'),
            (4, 'История', 'Сивый А.В.'),
            (5, 'Белорусский язык', 'Гапоненко Ю.В.'),
        ],
    },
    '6а': {
        ...
        'Четверг': [
            ...
            (4, 'Белорусская литература', 'Анисенко С.В.'),
    ...
    '6б': {
        'Понедельник': [
            ...
            (3, 'Русский язык', 'Шатило Н.И.'),
            (4, 'Физическая культура и здоровье', 'Смольский С.М.'),
            (5, 'Английский язык', 'Нечаева Е.Я./Приходько И.Н.'),
        ],
        'Вторник': [
    ...
    '7б': {
        ...
        'Среда': [
            ...
            (3, 'Белорусская литература', 'Лебедевская М.П.'),
            (4, 'Математика', 'Прихач Е.В.'),
            (5, 'Английский язык', 'Нечаева Е.Я./Штыхнова Л.Г.'),
        ],
        'Четверг': [
        ...
        'Пятница': [
            ...
            (3, 'Математика', 'Прихач Е.В.'),
            (4, 'Физическая культура и здоровье', 'Вергейчик В.Г.'),
            (5, 'Физическая культура и здоровье', 'Явош С.В.'),
        ],
    },
    '7в': {
        ...
        'Пятница': [
            ...
            (4, 'Физика', 'Зубок С.Н./Стишенок Н.И.'),
            (5, 'Физика', 'Гуд Ю.П.'),
        ],
    },
    '8а': {
    ...
    '8б': {
        ...
        'Пятница': [
            (1, 'Биология', 'Канунова В.Г.'),
            (2, 'Математика', 'Анисковец Н.В.'),
            (3, 'Физическая культура и здоровье', 'Вергейчик В.Л.'),
            (4, 'Русская литература', 'Леонова Д.А.'),
            (5, 'Белорусский язык (база)', 'Брель Ю.В.'),
        ],
    },
    '9а': {
        'Понедельник': [
            ...
            (4, 'Английский язык', 'Артюх М.П./Тихоненко О.А.'),
            (5, 'Биология (проф)', 'Даниленко А.А.'),
        ],
        'Вторник': [
            (1, 'Физика', 'Зубок С.Н.'),
            (2, 'Химия', 'Канунова В.Г.'),
            (3, 'Английский язык', 'Ковальчук К.Р./Тихоненко О.А.'),
            (4, 'Математика (проф)', 'Коротчикова Л.В.'),
            (5, 'Математика (база)', 'Назаренко Т.К.'),
        ],
        'Среда': [
            (1, 'Белорусский язык', 'Брель Ю.В.'),
            (2, 'Английский язык', 'Нечаева Е.Я./Приходько И.Н.'),
            (3, 'Информатика', 'Гуд Ю.П./Прихач Е.В.'),
            (4, 'Допризывная/медицинская подготовка', 'Даниленко А.А./Смольский С.М.'),
            (5, 'Математика', 'Назаренко Т.К.'),
        ],
        'Четверг': [
            (1, 'Белорусский язык', 'Лукьяненко Л.И.'),
            (2, 'Биология', 'Даниленко А.А.'),
            (3, 'Математика (проф)', 'Коротчикова Л.В.'),
            (4, 'Математика (база)', 'Назаренко Т.К.'),
            (5, 'Русский язык', 'Пинчук А.В.'),
        ],
        'Пятница': [
            (1, 'Физика', 'Зубок С.Н.'),
    ...
    '9б': {
        'Понедельник': [
            ...
            (2, 'Физическая культура и здоровье', 'Вергейчик В.Г./Смольский С.М.'),
            (3, 'Белорусская литература', 'Брель Ю.В.'),
            (4, 'Английский язык', 'Артюх М.П./Тихоненко О.А.'),
            (5, 'Химия (база)', 'Корольчук О.Г.'),
        ],
        'Вторник': [
            (1, 'Химия', 'Канунова В.Г.'),
            (2, 'Математика (проф)', 'Коротчикова Л.В.'),
            (3, 'Математика (база)', 'Назаренко Т.К.'),
            (4, 'Белорусская литература', 'Лебедевская М.П.'),
            (5, 'Химия (проф)', 'Корольчук О.Г.'),
        ],
        'Среда': [
        ...
        'Четверг': [
            ...
            (3, 'География', 'Юнах Т.В.'),
            (4, 'История', 'Сивый А.В.'),
            (5, 'Допризывная/медицинская подготовка', 'Даниленко А.А./Смольский С.М.'),
        ],
        'Пятница': [
            ...
            (5, 'Математика (проф)', 'Коротчикова Л.В.'),
        ],
    },
    '10а': {
        'Понедельник': [
            (1, 'Физическая культура и здоровье', 'Вергейчик В.Г./Смольский С.М.'),
            (2, 'Английский язык', 'Артюх М.П./Тихоненко О.А.'),
            (3, 'Английский язык (проф)', 'Приходько И.Н.'),
            (4, 'Химия (проф)', 'Корольчук О.Г.'),
            (5, 'Английский язык (проф)', 'Тихоненко О.А.'),
        ],
        'Вторник': [
            (1, 'Белорусская литература', 'Лебедевская М.П.'),
            (2, 'Физическая культура и здоровье', 'Смольский С.М.'),
            (3, 'Английский язык (проф)', 'Приходько И.Н.'),
            (4, 'Химия (проф)', 'Корольчук О.Г.'),
            (5, 'Английский язык (база)', 'Хорошко Т.А.'),
        ],
        'Среда': [
            ...
            (5, 'Русский язык (проф)', 'Пинчук А.В.'),
        ],
        'Четверг': [
            (1, 'География', 'Юнах Т.В.'),
        ...
        'Пятница': [
            (1, 'Математика (проф)', 'Коротчикова Л.В.'),
            (2, 'Математика (база)', 'Назаренко Т.К.'),
            (3, 'Физика', 'Гуд Ю.П.'),
            (4, 'Английский язык', 'Хорошко Т.А.'),
            (5, 'Русский язык (проф)', 'Пинчук А.В.'),
        ],
    },
    '10б': {
        'Понедельник': [
            ...
            (2, 'Биология (база)', 'Даниленко А.А.'),
            (3, 'Русский язык (база)', 'Пинчук А.В.'),
            (4, 'История (проф)', 'Королёва Ж.В.'),
            (5, 'Биология (проф)', 'Даниленко А.А.'),
        ],
        'Вторник': [
            (1, 'Белорусская литература', 'Лукьяненко Л.И.'),
            (2, 'История', 'Королёва Ж.В.'),
            (3, 'Русский язык (проф)', 'Пинчук А.В.'),
            (4, 'Физическая культура и здоровье', 'Смольский С.М.'),
            (5, 'Химия (проф)', 'Корольчук О.Г.'),
        ],
        'Среда': [
            (1, 'Информатика', 'Гуд Ю.П./Назаренко Т.К.'),
            (2, 'Математика', 'Назаренко Т.К.'),
            (3, 'Белорусский язык (проф)', 'Анисенко С.В.'),
            (4, 'Биология (проф)', 'Даниленко А.А.'),
            (5, 'Химия (проф)', 'Корольчук О.Г.'),
        ],
        'Четверг': [
            (1, 'Русская литература', 'Леонова Д.А.'),
        ...
        'Пятница': [
            (1, 'Биология (база)', 'Канунова В.Г.'),
            (2, 'Химия (проф)', 'Корольчук О.Г.'),
            (3, 'Математика', 'Назаренко Т.К.'),
            (4, 'Английский язык (проф)', 'Тихоненко О.А.'),
            (5, 'Химия (проф)', 'Корольчук О.Г.'),
        ],
    },
    '11': {
        'Понедельник': [
            (1, 'Биология (база)', 'Даниленко А.А.'),
            (2, 'Химия (проф)', 'Корольчук О.Г.'),
            (3, 'Биология (проф)', 'Даниленко А.А.'),
            (4, 'Химия (база)', 'Корольчук О.Г.'),
            (5, 'Обществоведение', 'Королёва Ж.В.'),
        ],
        'Вторник': [
            (1, 'Белорусская литература', 'Лукьяненко Л.И.'),
            (2, 'История', 'Королёва Ж.В.'),
            (3, 'Физическая культура и здоровье', 'Вергейчик В.Л./Явош С.В.'),
            (4, 'Астрономия', 'Стишенок Н.И.'),
            (5, 'Английский язык (проф)', 'Тихоненко О.А.'),
        ],
        'Среда': [
            (1, 'Информатика', 'Гуд Ю.П./Прихач Е.В.'),
            (2, 'География', 'Юнах Т.В.'),
            (3, 'Допризывная/медицинская подготовка', 'Даниленко А.А./Смольский С.М.'),
        ...
        'Четверг': [
            ...
            (3, 'Биология (проф)', 'Канунова В.Г.'),
            (4, 'Химия (база)', 'Корольчук О.Г.'),
            (5, 'Английский язык (проф)', 'Приходько И.Н.'),
        ],
        'Пятница': [
            (1, 'Физическая культура и здоровье', 'Явош С.В.'),
            (2, 'Русская литература', 'Пинчук А.В.'),
            (3, 'Английский язык', 'Хорошко Т.А.'),
            (4, 'Русский язык (проф)', 'Пинчук А.В.'),
            (5, 'Химия (проф)', 'Корольчук О.Г.'),
        ],
    },
}
