...
SCHEDULE_STRUCTURED = {
    ...
    '10а': {
        ...
        'Среда': [
            ...
            (4,'физкультура','Смольский С.М./Вергейчик В.Л.'),
        ...
        'Четверг': [
            (1,'Русская литература','Пинчук А.В.'),
            (2,'Математика (проф)/Математика (база)','Коротчикова Л.В./Назаренко Т.К.'),
            (3,'Русский язык','Пинчук А.В.'),
            (4,'История','Сивый А.В.'),
            (5,'География','Юнах Т.В.'),
            (6,'Обществоведение','Сивый А.В.'),
        ...
        'Пятница': [
            (1,'Математика (проф)/Математика (база)','Коротчикова Л.В./Назаренко Т.К.'),
            (2,'Биология','Канунова В.Г.'),
            (3,'Белорусский язык (база)/Математика (проф)','Брель Ю.В./Коротчикова Л.В.'),
    ...
    '10б': {
        ...
        'Четверг': [
            ...
            (4,'физкультура','Смольский С.М.'),
            (5,'Математика','Назаренко Т.К.'),
            (6,'Допризывная/медицинская подготовка','Даниленко А.А./Смольский С.М.'),
            (7,'Английский язык (проф)','Приходько И.Н.'),
        ],
        'Пятница': [
            ...
            (3,'Физика','Коротчикова Л.В.'),
            (4,'Математика','Назаренко Т.К.'),
            (5,'Биология (база)/Химия (проф)','Канунова В.Г./Корольчук О.Г.'),
            (6,'Обществоведение','Сивый А.В.'),
        ],
    },
    '11': {
        ...
        'Четверг': [
            ...
            (4,'Физика','Стишенок Н.И.'),
            (5,'Биология (проф)/Химия (база)','Канунова В.Г./Корольчук О.Г.'),
            (6,'Английский язык (проф)/Биология (проф)','Тихоненко О.А./Даниленко А.А.'),
        ],
        'Пятница': [
            (1,'физкультура','Явош С.В.'),
            (2,'Русская литература','Пинчук А.В.'),
            (3,'Английский язык/Русский язык (проф)','Хорошко Т.А./Пинчук А.В.'),
            (4,'Биология (проф)/Химия (база)','Канунова В.Г./Корольчук О.Г.'),
            (5,'Математика','Коротчикова Л.В.'),
            (6,'Биология (проф)/Английский язык (проф)','Канунова В.Г./Тихоненко О.А.'),
