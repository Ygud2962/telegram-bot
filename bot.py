...
# Если не нашли, используем встроенный (замените на ваш!)
if not TOKEN:
    TOKEN = "ЗДЕСЬ НИЧЕГО НЕ ПИШЕМ!"
    print("⚠️ ВНИМАНИЕ: Используется токен из кода. Для безопасности лучше использовать переменные окружения!")
