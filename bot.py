...
SCHEDULE_STRUCTURED = {
    ...
    '5б': {
        'Понедельник': [
            ...
            (3, 'Английский язык', 'Приходько И.Н.'),
            (4, 'Физкультура', 'Вергейчик В.Л.'),
            (5, 'ОБЖ', 'Юнах Т.В.'),
    ...
    '5в': {
        'Понедельник': [
            ...
            (3, 'Английский язык', 'Ковальчук К.Р.'),
            (4, 'Английский язык', 'Ковальчук К.Р.'),
    ...
    '6а': {
        'Понедельник': [
            ...
            (4, 'Английский язык', 'Тихоненко О.А.'),
    ...
    '6б': {
        'Понедельник': [
            ...
            (3, 'История/Бел. язык', 'Сивый А.В./Гапоненко Ю.В.'),
    ...
    '9а': {
        ...
        'Среда': [
            ...
            (3, 'Информатика', 'Гуд Ю.П./Прихач Е.В.'),
            (4, 'История', 'Королёва Ж.В.'),
            (5, 'Химия', 'Канунова В.Г.'),
            (6, 'Бел. литература', 'Лукьяненко Л.И.'),
            (7, 'Физкультура', 'Вергейчик В.Л.')
        ],
        'Четверг': [
    ...
    '10а': {
        'Понедельник': [
            ...
            (7, 'История', 'Королёва Ж.В./Сивый А.В.')
        ],
        'Вторник': [
        ...
        'Среда': [
            ...
            (6, 'История Бел', 'Королёва Ж.В./Сивый А.В.'),
