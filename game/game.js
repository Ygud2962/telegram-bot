...
function normalizeReferralAgents(rawList) {
  ...
  return rawList.slice(0, 20).map((item) => {
    ...
    return {
      ...
      name: String(src.name || 'РРіСЂРѕРє'),
...
// Р вЂ”Р В°Р С–РЎР‚РЎС“Р В¶Р В°Р ВµР С РЎвЂљР В°Р В±Р В»Р С‘РЎвЂ РЎС“ Р В»Р С‘Р Т‘Р ВµРЎР‚Р С•Р Р† Р С‘Р В· Р В±Р С•РЎвЂљР В° (Р ВµРЎРѓР В»Р С‘ Р С—Р ВµРЎР‚Р ВµР Т‘Р В°Р Р…Р В°) Р Р† state
function mergeBotLeaderboard() {
  ...
  if (tgInitMe && myUid) {
    ...
    if (!mergeResult.applied) {
      if (incomingResetToken > 0) _storeResetToken(incomingResetToken);
      // Р вЂєР С•Р С”Р В°Р В»РЎРЉР Р…РЎвЂ№Р в„– Р С—РЎР‚Р С•Р С–РЎР‚Р ВµРЎРѓРЎРѓ Р Р…Р С•Р Р†Р ВµР Вµ РЎРѓР ВµРЎР‚Р Р†Р ВµРЎР‚Р Р…Р С•Р С–Р С• РІР‚вЂќ Р С—Р С•Р Т‘Р Р…Р С‘Р СР В°Р ВµР С Р вЂР вЂќ Р В°Р Р†РЎвЂљР С•РЎРѓР С‘Р Р…Р С”Р С•Р С.
...
function renderChapters() {
  ...
  CHAPTERS.forEach((ch, i) => {
    ...
    card.innerHTML = `
      ...
      <div class="ch-inner">
        <div class="ch-num">${ch.subtitle} В· ${statusText}</div>
...
function loadCipher() {
  ...
  if (chapterLabelEl) chapterLabelEl.textContent = ch.subtitle + ' В· ' + ch.place;
...
function renderChapterEpicSummary(chapter, stats, pct, medal, artifactsGained) {
  ...
  const artifactsLine = gained.length
    ? gained.map(a => `${a.icon} ${a.name}`).join(' В· ')
...
function renderProfileTab() {
  ...
  el.innerHTML = `
    ...
    <div style="background:#141108;border:1px solid rgba(120,215,255,.22);border-radius:8px;padding:14px;margin-bottom:12px">
      ...
      <div style="font-size:10px;color:var(--muted);margin-bottom:6px">РЎРїРёСЃРѕРє Р°РіРµРЅС‚РѕРІ</div>
      ${referralRows}
    </div>
...
// в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ
//  РЎРРЎРўР•РњРђ Р”РћРЎРўРР–Р•РќРР™ (50 С€С‚СѓРє)
// в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ
const ACHIEVEMENTS = [
