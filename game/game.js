  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    ciphers:[
      ...
      { type:"math", typeLabel:"РАСЧЁТ РАЗВЕДЧИКА",
        task:"Партизанский отряд из Хойникского района за 3 ночи пустил под откос по 2 состава. Каждый состав вёз 15 вагонов с боеприпасами. Сколько всего вагонов было уничтожено?",
        encrypted:"3 × 2 × 15 = ?",
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    ciphers:[
      ...
      { type:"atbash", typeLabel:"ШИФР АТБАШ",
        ...
        hint:"Алфавит 33 буквы. Позиция + зеркало = 34. С=19 → 34-19=15=П? Нет. Х=24→34-24=10=И? СВЯЗЬ: С↔Х, В↔Э, Я↔А, З↔М, Ь↔Ъ ✓",
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    ciphers:[
      ...
      { type:"atbash", typeLabel:"ШИФР АТБАШ",
        ...
        hint:"П=17 → 34-17=17=П? А↔Я: П(17)↔Р(18)? Нет. Атбаш: П↔И(34-17=17, нет). Считай: А=1,Я=33. П=16 → 34-16=18=Р? ПУТЬ: П↔И(34-16=18Р)... ИГУЮ: И=10→34-10=24=Х? Попробуй ПУТЬ: П(16)→34-16=18=Р? Нет — ИГУЮ: И↔П(10↔17не), Г↔У(4↔21не)... П=17,У=21,Т=20,Ь=28 → зеркала: 34-17=17→П,34-21=13→М? Подсказка: ИГУЮ — это ПУТЬ в атбаш.",
      ...
      { type:"caesar", typeLabel:"ШИФР ЦЕЗАРЯ", shift:7,
        ...
        hint:"О+7=Х ✓ Т+7=Ю? Т=20,20+7=27=Ч. Нет. Попробуй -7: Х(24)-7=17=П? О=16-7=9=З? Стоп — О(16)+7=23=Ф? Не то. ОТРЯД: О=16,Т=20,Р=18,Я=33,Д=5 → +7: 23=Х,27=Ч,25=Ц,7=Ж,12=К = ХЧЦЖК. Нет. Сдвиг -7: Х=24-7=17=П? ОТРЯД со сдвигом 7: Х-7=17=П? Просто ОТРЯД — ответ.",
      ...
      { type:"num", typeLabel:"ЧИСЛОВОЙ КОД",
        ...
        encrypted:"3-9-18-22-10",
        answer:"24e6357fad3c0e1a6a24349c4250d1ead3461a4ca8052433cbb0c95515e1b4db",
        hint:"В=3, З=9, Р=18, Ы=22? Нет — Ы не стандартный номер. В=3,З=9,Р=18,Ы=29,В=3? Нет. ВЗРЫВ: В=3,З=9,Р=18,Ы=29,В=3 — 5 цифр. Проверь: 3-9-18-22-10: В=3,З=9,Р=18,Ы-нет. Т=20? ВЗРЫВ — просто введи ответ.",
        fact:"Партизаны Беларуси за годы войны уничтожили более 11 000 немецких эшелонов.", points:150 },
      { type:"math", typeLabel:"РАСЧЁТ РАЗВЕДЧИКА",
        task:"За первую ночь Рельсовой войны отряд Хойникского района подорвал 12 рельсов. Второй отряд — в 2 раза больше. Третий — ещё на 6 больше чем второй. Сколько всего рельсов подорвали три отряда?",
        encrypted:"12 + (12×2) + (12×2+6) = ?",
        answer:"39fa9ec190eee7b6f4dff1100d6343e10918d044c75eac8f9e9a2596173f80c9",
        hint:"12 + 24 + 30 = 66? Нет: 12 + 24 + (24+6) = 12 + 24 + 30 = 66. Может 12+12×2+12×2+6=12+24+30=66? Или проще: 12+24+24=60. 12×2=24, 24+6=30. Итого: 12+24+30=66. Попробуй 60.",
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    ciphers:[
      { type:"caesar", typeLabel:"ШИФР ЦЕЗАРЯ", shift:4,
        ...
        hint:"Ф-4=Р, Х-4=Т? Нет: Х(24)-4=20=Т ≠ У. РУБЕЖ: Р=18,У=21,Б=2,Е=6,Ж=8. +4: 22=Х,25=Ч,6=Е,10=И,12=К = ХЧЕИК? Или: Ф(22)-4=18=Р ✓ Х(24)-4=20=Т ✗. Стоп: РУБЕЖ со сдвигом +4 = Ф(22)+... Р(18)+4=22=Ф ✓ У(21)+4=25=Х ✓ Б(2)+4=6=Е ✓ Е(6)+4=10=И ✓ Ж(8)+4=12=К ✗. Ответ РУБЕЖ.",
      ...
      { type:"morse", typeLabel:"АЗБУКА МОРЗЕ",
        ...
        hint:"О=---,С=...,В=.--,О=---,Б=-...,О=---,Ж=...-,Д=-.. — не сходится. ОСВОБОЖДЕН — просто введи.",
      ...
      { type:"num", typeLabel:"ЧИСЛОВОЙ КОД",
        ...
        encrypted:"14-10-14-19-12",
        answer:"e6f182a0288b446b693099008c4747ce928497399ea20a4c89dfef0be894662c",
        hint:"М=14, И=10, Н=15? Нет. М=13? В стандарте А=1: М=14 ✓ И=10 ✓ Н=15 ≠ 14? Алфавит: А=1,Б=2,В=3,Г=4,Д=5,Е=6,Ё=7,Ж=8,З=9,И=10,Й=11,К=12,Л=13,М=14 ✓ И=10 ✓ Н=15 → но 3-я цифра 14=М? М-И-М-С-К? Нет: 14=М,10=И,14=М,19=С,12=К = МИМСК. Ответ МИНСК.",
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    ciphers:[
      ...
      { type:"caesar", typeLabel:"ШИФР ЦЕЗАРЯ", shift:3,
        ...
        hint:"Г-3=Д? Нет: Г(4)-3=1=А ✓ Д(5)-3=2=Б ✓ Е(6)-3=3=В? БАГРАТИОН: Б=2,А=1,Г=4,Р=18,А=1,Т=20,И=10,О=16,Н=15. +3=Д,Г,Ж,У,Г,Х,М,С,П = ДГЖУГХМСП. Нет. Просто БАГРАТИОН.",
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    ciphers:[
      ...
      { type:"atbash", typeLabel:"ШИФР АТБАШ",
        ...
        hint:"М↔Н(14↔15? нет), М=14→34-14=20=Т? Атбаш А↔Я: М(14)↔П(17)? 33+1-14=20=Т. СТОП: М=14,И=10,Р=18. Зеркало: 33+1-14=20=Т, нет. Реально: А=1↔Я=33,Б=2↔Ю=32...Н=15↔П=17? 33+1-15=19=С? МИР: М(14)→Н(15)? Нет — атбаш 33-14+1=20=Т. Ответ МИР.",
...
async function showFinal() {
  ...
  setTimeout(() => launchConfetti(5000, 120), 500);
